...
/** Verifies architecture constraints for the manager module based on the flow plan. */
@AnalyzeClasses(packagesOf = OrderHunterManagerApplication.class)
class ManagerArchitectureRulesTest {

  private static final String BASE_PACKAGE = "name.golets.order.hunter.manager";
