package name.golets.order.hunter.orderhunterworker.controller;

import name.golets.order.hunter.orderhunterworker.event.StartEvent;
import name.golets.order.hunter.orderhunterworker.event.StatusEvent;
import name.golets.order.hunter.orderhunterworker.event.StopEvent;
import name.golets.order.hunter.orderhunterworker.state.WorkerStateManager;
import name.golets.order.hunter.orderhunterworker.state.WorkerStatusSnapshot;
